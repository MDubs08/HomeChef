    ...
    public partial class initialMigration : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        HolidayMeal = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.ID);
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        RecipeReviewID = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.ID)
                ...
                .ForeignKey("dbo.RecipeReviews", t => t.RecipeReviewID, cascadeDelete: true)
